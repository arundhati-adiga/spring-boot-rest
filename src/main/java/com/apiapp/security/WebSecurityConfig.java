...
/**
 * This class extends the WebSecurityConfigurerAdapter and customizes httpsecurity
...
// dont authenticate this particular request
				.authorizeRequests().antMatchers("/authenticate", "/swagger-ui.html", "/swagger-ui-custom.html",
						"/api-docs", "/configuration/**", "/swagger*/**", "/webjars/**")
				.permitAll().
